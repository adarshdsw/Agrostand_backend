...
class NotifyUserPickUpDone extends Notification
{
    use Queueable;
    ...
    {
        $title = __('messages.notification.pickup_done.title');
        $body = __('messages.notification.pickup_done.body', ['orde_id'=>$this->ebill->orde_id]);
