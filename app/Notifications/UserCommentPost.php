...
class UserCommentPost extends Notification
{
    use Queueable;
    ...
    {
        $title  = __('messages.notification.post_comment.title', [ 'user' => $this->user_name]);
        $body   = $this->post_title;
        $custom_data = json_encode(['post_id' => $this->post_comment->post_id, 'case' => 'post_comment']);
    ...
    {
        return [
            'title' => __('messages.notification.post_comment.title'),
            'body' => __('messages.notification.post_comment.body'),
            'url' => '/',
            'custom_data' => ['post_id' => $this->post_comment->post_id, 'case' => 'post_comment'],
        ];
    }
}
