...
class EbillProducts extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['category_id','subcategory_id','commodity_id','product_name','packet_number','total_volume','volume_unit','product_rate','rate_unit','product_tax','product_image','specification','subtotal',
    ];
