    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div><h4 class="card-title">Edit Staff</h4></div>
                <div class="float-right">
                  <a href="{{route('admin.staffs.index')}}" class="btn btn-sm btn-primary">Back</a>
                </div>
            </div>
            <div class="card-content">
              <form method="post" action="{{ route('admin.staffs.update', [$staff->id]) }}" id="edit-staff-form">
                <div class="card-body">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="avatar mr-1 avatar-xl">
                              <img id="user_profile_preview" src="{{ ($staff->profile_image) ? asset('user_media').'/'.$staff->profile_image : asset('frest/images/portrait/small/avatar-s-20.jpg')}}" alt="avtar img holder">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email" value="{{ ($staff) ? $staff->email : '' }}">
                            </fieldset>
                        </div>
                        <div class="col-md-6">
                            <fieldset class="form-group">
                                <label for="mobile">Mobile</label><span class="text-error">&#42;</span>
                                <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter Mobile" value="{{ ($staff) ? $staff->mobile : '' }}">
                            </fieldset>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password" value="{{ ($staff) ? $staff->password : '' }}">
                            </fieldset>
                        </div>
                        <div class="col-md-6">
                            <fieldset class="form-group">
                                <label for="conf_password">Confirm Password</label><span class="text-error">&#42;</span>
                                <input type="password" class="form-control" id="conf_password" name="conf_password" placeholder="Enter Confirm Password" value="{{ ($staff) ? $staff->password : '' }}">
                            </fieldset>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset class="form-group">
                                ...
                                <textarea class="form-control" id="address" name="address" rows="3" placeholder="Type Address" style="margin-top: 0px; margin-bottom: 0px; height: 92px;">{{ ($staff) ? $staff->address : '' }}</textarea>
                            </fieldset>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="d-flex p-2 float-right">
                          <button class="btn btn-primary" type="submit" id="submit" name="submit" value="edit" >Edit</button>&nbsp;
...
<script>
    $(document).ready(function(){
      ...
      $('#edit-staff-form').submit(function(event){
        ...
        var that = $(this)[0];
        var url = "{{ route('admin.staffs.update', [$staff->id]) }}";
        ...
        $.ajax({
          ...
          success : function(res){
            toastr.success("Success", "Staff Edited successfully!");
