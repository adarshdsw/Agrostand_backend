	...
	<tr>
		<td>
			<table border="0" cellpadding="10" cellspacing="0" width="100%">
				<tr>
					<td>
						<p style="margin: 0;">Welcome <span> {{ $data['name'] }}</span> ,</p>
					</td>
				</tr>
				<tr>
					<td>
						<p>Thanks For Signing Up With My Agrostand</p>
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>
						<p style="margin: 0;">User Data</p>
					</td>
				</tr>
				<tr>
					<td><p style="margin: 0;"><span style="font-weight: bold; width: 15%; display: inline-block;">Email</span> {{ $data['email'] }}</p></td>
				</tr>
				<tr>
					<td><p style="margin: 0;"><span style="font-weight: bold; width: 15%; display: inline-block;">User Code</span> {{ $data['user_code'] }}</p></td>
				</tr>
	     		<tr>
	     			<td>
	     		...
	     		<tr>
	     			<td>
	     				...
	     				<p style="margin: 10px 0; font-size: 16px;font-weight: bold;color: #f06135; ">AGROSTAND Team</p>
	     			</td>
	     		</tr>
				<tr>
