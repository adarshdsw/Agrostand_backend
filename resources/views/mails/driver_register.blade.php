...
<html>
<head>
	<title>Driver Registration - AgroStand</title>
	...
	<tr>
		<td>
			<table border="0" cellpadding="10" cellspacing="0" width="100%">
				<tr>
					<td>
						<p style="margin: 0;">Hello <span> {{ $data['driver']->name }}</span> ,</p>
					</td>
				</tr>
				<tr>
					<td>
						<p>Thanks For Registered With My Agrostand</p>
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>
						<p style="margin: 0;">Driver Login Details</p>
					</td>
				</tr>
				<tr>
					<td><p style="margin: 0;"><span style="font-weight: bold; width: 15%; display: inline-block;">Mobile Number</span> {{ $data['driver']->mobile }}</p></td>
				</tr>
				<tr>
					<td><p style="margin: 0;"><span style="font-weight: bold; width: 15%; display: inline-block;">Password</span> {{ $data['driver']->conf_password }}</p></td>
				</tr>
				<!-- Bill data start -->
				<tr>
					<td>
						<p style="margin: 0;">Bill Data</p>
					</td>
				</tr>
				<tr>
