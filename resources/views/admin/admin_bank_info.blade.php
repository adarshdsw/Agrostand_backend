								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-12">
											<div class="col-md-12">
												<div class="form-group">
													<label for="term_condition">Term & Condition</label><span class="text-danger">&#42;</span>
													<textarea class="form-control" id="term_condition" name="term_condition" rows="5">{{ isset($admin_bank) ? $admin_bank->term_condition : old('term_condition') }}</textarea>
										...
										<div class="col-12">
											<div class="col-md-12">
												<div class="form-group">
													<label for="term_condition_hindi">Term & Condition [Hindi]</label><span class="text-danger">&#42;</span>
													<textarea class="form-control" id="term_condition_hindi" name="term_condition_hindi" rows="5">{{ isset($admin_bank) ? $admin_bank->term_condition_hindi : old('term_condition_hindi') }}</textarea>
												</div>
											</div>
										</div>
									</div>
