								...
								<table class="table table-striped">
									...
									<tbody>
										@foreach($ebill->products as $product)
											<tr>
												<td>
													<a href="{{ ($product) ? $product->product_image : '' }}" data-toggle="lightbox">
														<img src="{{ $product->product_image }}" width="50" height="50">
													</a>
												</td>
										...
										<div class="col-12">
											...
											@if($ebill->shipping->shipping_type == '2')
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<a href="{{ ($ebill->shipping) ? $ebill->shipping->courier_receipt_img : '' }}" data-toggle="lightbox">
											...
											@if($ebill->shipping->shipping_type == '3')
													...
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<a href="{{ ($ebill->shipping) ? $ebill->shipping->lt_driver_img : '' }}" data-toggle="lightbox">
													...
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<a href="{{ ($ebill->shipping) ? $ebill->shipping->lt_loading_vehcile_img : '' }}" data-toggle="lightbox">
													...
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<a href="{{ ($ebill->shipping) ? $ebill->shipping->lt_driver_identity_img : '' }}" data-toggle="lightbox">
