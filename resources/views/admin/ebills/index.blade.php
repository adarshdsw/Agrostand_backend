	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Ebills</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
						<table class="table table-hover text-nowrap my-datatable" id="ebills-table">
							<thead>
								<tr>
									<th style="width: 10px">#</th>
									<th>Order Id</th>
									<th style="width: 190px; text-align: center; ">Bill Number</th>
									<th>Sender</th>
									<th>Receiver</th>
									<th>Bill Date</th>
									<th>Due Date</th>
	...
	@section('js')
		<script>
			...
			$(function () {
				...
				var table = $('#ebills-table').DataTable({
					processing	: true,
					serverSide	: true,
					scrollX		: true,
					ajax: {
						url: base_url+'/admin/ebills-data',
						method: 'POST',
						data: function (d) {
					...
					columns: [
						...
						{data: 'download_ebill', 	name: 'download_ebill', orderable: false, searchable: false},
