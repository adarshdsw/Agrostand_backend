...
return [
    ...
    */
    ...
    'admin' => [
        ...
        'ebill_shipping' => [
            'index' => 'ebill_shipping',
            'create' => 'ebill_shippingCreate',
            'edit' => 'ebill_shippingEdit',
        ],
        'driver_assignments' => [
            'index' => 'driver_assignments',
            'create' => 'driver_assignmentsCreate',
            'edit' => 'driver_assignmentsEdit',
        ],
        'hold_payment' => [
            'index' => 'hold_payment',
            'create' => 'hold_paymentCreate',
            'edit' => 'hold_paymentEdit',
        ],
        'villages' => [
            'index' => 'villages',
            'create' => 'villagesCreate',
            'edit' => 'villagesEdit',
        ],
        'agromeets' => [
            'index' => 'agromeets',
            'create' => 'agromeetsCreate',
            'edit' => 'agromeetsEdit',
        ],
        'settings'  => 'settings',
        'bank'      => 'bank',
