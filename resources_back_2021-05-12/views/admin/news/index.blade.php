		 ...
		 <div class="row">
			<div class="col-12 col-sm-12 col-md-12 col-lg-12">
        				...
        				<form method="POST" id="search-form" class="form-inline" role="form">
        					...
        					<div class="col-md-5">
        						<div class="form-group d-flex align-items-center">
        							<label for="news_title" class="col-form-label mr-3">News Title</label>
        							<input type="text" class="form-control" id="news_title" name="news_title" placeholder="Search Title">
        						</div>
        					</div>
        					<div class="col-md-5">
        						<div class="form-group d-flex align-items-center">
			   ...
			   <div class="card card-primary card-outline card-outline-tabs">
				  <div class="card-body">
					<table class="table table-hover text-nowrap my-datatable" id="news-table">
						<thead>
							<tr>
								<th>ID</th>
								<th>Image</th>
