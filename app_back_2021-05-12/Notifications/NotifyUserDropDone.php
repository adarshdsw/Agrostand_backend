...
class NotifyUserDropDone extends Notification
{
    use Queueable;
    ...
    {
        $title = __('messages.notification.drop_done.title');
        $body = __('messages.notification.drop_done.body', ['orde_id'=>$this->ebill->orde_id]);
