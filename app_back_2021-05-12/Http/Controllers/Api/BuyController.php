...
class BuyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $products = Product::with(['offer','price','user','category','brand','group'])
                        ->where('product_tags', 'regexp', '(^|,)('.$search_str.')(,|$)')
                        ->orWhere('product_title', 'regexp', '(^|,)('.$search_str.')(,|$)')
        ...
        $total_count = Product::with(['offer', 'price', 'user'])
                        ...
                        ->when ((isset($perameters['avg_ratting']) && $perameters['avg_ratting'] !== '' && !empty($perameters['assured_id']) ), function ($query) use ($perameters) {
    ...
    public function leadList(Request $request){
        ...
        $buylead_list = Buy::with(['user', 'category', 'city', 'state', 'district'])
                            ->where('product_title', 'regexp', '(^|,)('.$search_str.')(,|$)')
                            // catagory wise
